...
parser.add_argument('--label_path',type=str,default='/home/yihe/ubuntu')
parser.add_argument('--save_file',type=str,default='./result8.csv')
parser.add_argument('--model_file',type=str,default='./29_model8.pth.tar')
